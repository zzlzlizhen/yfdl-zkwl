package com.remote.advancedsetting.controller;
...
public class AdvancedSettingController{
    ...
    public R update(AdvancedSettingEntity advancedSetting){
        ...
        try {
            ...
            sysUserEntity.setUserId(advancedSetting.getUid());
            sysUserEntity.setUsername(advancedSetting.getUpdateUser());
            advancedSettingService.addUpdateGroup(advancedSetting,sysUserEntity);
            return R.ok();
        }catch (Exception e){
            e.printStackTrace();
    ...
    public R updateDevice(AdvancedSettingEntity advancedSetting){
        ...
        try {
            ...
            sysUserEntity.setUserId(advancedSetting.getUid());
            sysUserEntity.setUsername(advancedSetting.getUpdateUser());
            advancedSettingService.addUpdateDevice(advancedSetting,sysUserEntity);
            return R.ok();
        }catch (Exception e){
            e.printStackTrace();
            return  ErrorMsg.errorMsg(asc,ErrorCode.ABNORMAL,"数据保存失败");
