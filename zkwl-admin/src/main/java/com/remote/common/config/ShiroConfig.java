...
import com.remote.modules.sys.shiro.UserRealm;
...
public class ShiroConfig {
    ...
    public DefaultWebSessionManager sessionManager(@Value("${shebei.globalSessionTimeout:3600}") long globalSessionTimeout){
